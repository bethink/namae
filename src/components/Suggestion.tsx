...
const MODIFIERS: Modifier[] = [
  ...
  // --- custom ---
  (word): string => njoin(capitalize(word), 'Dev', { elision: false }),
  (word): string => njoin(capitalize(word), 'DAO', { elision: false }),
  (word): string => njoin(capitalize(word), 'DApp', { elision: false }),
  (word): string => njoin(capitalize(word), 'Empire', { elision: false }),
  (word): string => njoin(capitalize(word), 'Crypto', { elision: false }),
  (word): string => njoin(capitalize(word), 'Crush', { elision: false }),
  (word): string => njoin(capitalize(word), 'Verse', { elision: false }),
  (word): string => njoin(capitalize(word), 'Magic', { elision: false }),
  (word): string => njoin(capitalize(word), 'Star'),
  (word): string => njoin(capitalize(word), 'Reels'),
  (word): string => njoin(capitalize(word), 'Reel'),
  (word): string => njoin(capitalize(word), 'xyz'),
  (word): string => njoin(capitalize(word), 'anime', { elision: false }),
  (word): string => njoin(capitalize(word), 'Virtual', { elision: false }),
  (word): string => njoin(capitalize(word), 'Hacker', { elision: false }),
  (word): string => njoin(capitalize(word), 'Market', { elision: false }),
  (word): string => njoin(capitalize(word), 'Vision', { elision: false }),
  (word): string => njoin(capitalize(word), 'Vortex', { elision: false }),
  (word): string => njoin(capitalize(word), 'Voyage', { elision: false }),
  (word): string => njoin(capitalize(word), 'Game', { elision: false }),
  (word): string => njoin(capitalize(word), 'Gamer', { elision: false }),
  (word): string => njoin(capitalize(word), 'Games', { elision: false }),
  (word): string => njoin(capitalize(word), 'Music', { elision: false }),
  (word): string => njoin(capitalize(word), 'Quest', { elision: false }),
  (word): string => njoin(capitalize(word), 'Store', { elision: false }),
  (word): string => njoin(capitalize(word), 'nft', { elision: false }),
  (word): string => njoin(capitalize(word), 'spectacular', { elision: false }),
  (word): string => njoin(capitalize(word), 'BYC', { elision: false }),
  (word): string => njoin(capitalize(word), 'punk', { elision: false }),
  (word): string => njoin(capitalize(word), 'NYC', { elision: false }),
  (word): string => njoin(capitalize(word), 'Genisys'),
  (word): string => njoin(capitalize(word), 'Alpha'),
  (word): string => njoin(capitalize(word), 'Beta'),
  (word): string => njoin(capitalize(word), 'Gama'),
  (word): string => njoin(capitalize(word), 'DID', { elision: false }),
  (word): string => njoin(lower(word), 'ism', { elision: false }),
  (word): string => njoin('0x', capitalize(word)),
];
